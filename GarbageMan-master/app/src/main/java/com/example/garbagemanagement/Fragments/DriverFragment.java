...
import com.example.garbagemanagement.Activities.DriverProfile;
import com.example.garbagemanagement.Activities.EditProfileActivity;
...
public class DriverFragment extends Fragment  implements View.OnClickListener{
    ...
    private TextView txtPhoneNumber, textviewplateno,txtFullName, txtemail;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        textviewplateno = v.findViewById(R.id.textviewplateno);
        isNotify = false;
        ...
        databaseReference.child("drivers").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (driver != null) {
                    txtFullName.setText(driver.getFullName());
                    txtemail.setText(driver.getEmail());
                    txtPhoneNumber.setText(driver.getPhoneNumber());
                    textviewplateno.setText(driver.getPlateNumber());
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnEditProfile:
                Intent iEditProfile = new Intent(getActivity(), DriverProfile.class);
                Bundle bundle = new Bundle();
                bundle.putString("USERID",uid);
                bundle.putString("EMAIL",driver.getEmail());
                bundle.putString("FULLNAME",driver.getFullName());
                bundle.putString("PHONENUMBER",driver.getPhoneNumber());
                bundle.putString("PLATENUMBER",driver.getPlateNumber());
                bundle.putString("WORKADDRESS",driver.getWorkaddress());
