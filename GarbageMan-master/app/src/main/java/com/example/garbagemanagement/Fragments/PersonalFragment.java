...
public class PersonalFragment extends Fragment implements View.OnClickListener{
    ...
    private TextView txtPhoneNumber, txtcity, txtsector,txtstreetno, txtFullName, txtemail;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        txtstreetno = v.findViewById(R.id.textviewstreetno);
        txtsector = v.findViewById(R.id.textviewstreetno);
        txtcity = v.findViewById(R.id.textviewstreetno);
        isNotify = false;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnEditProfile:
                ...
                bundle.putString("CITY",account.getCity());
                bundle.putString("SECTOR",account.getSector());
                bundle.putString("STREETNO",account.getStreetno());
