...
public class UserAdapter extends FirebaseRecyclerAdapter<Account,UserAdapter.myviewholder> {

    public UserAdapter(@NonNull FirebaseRecyclerOptions<Account> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final UserAdapter.myviewholder holder, final int position, @NonNull final Account model) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.name.getContext())
                        .setContentHolder(new ViewHolder(R.layout.dialoguser))
                        .setExpanded(true, 2000)
                        .create();

                View myview = dialogPlus.getHolderView();
                final EditText name = myview.findViewById(R.id.ufn);
